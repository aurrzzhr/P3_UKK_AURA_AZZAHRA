...
Route::middleware('auth')->group(function () {
  ...
  Route::prefix('/')->middleware('role:Admin')->group(function () {
    ...
    Route::get('update-status-laundry','Admin\PelayananController@updateStatusLaundry');

    // Customer
    Route::get('customers','Admin\CustomerController@index');
    Route::get('customers/{id}','Admin\CustomerController@detail');
    ...
    Route::get('add-order','Admin\PelayanController@addorders');
    Route::get('update-status-laundry','Admin\PelayanController@updateStatusLaundry');
    ...
    // Finance
    Route::get('keuangan','Admin\FinanceController@index')->name('finance.index');
    ...
    Route::get('export-excel','Admin\LaporanController@exportExcel');

    // Invoice
    Route::get('invoice-kar/{id}','Admin\InvoiceController@invoiceka');
  ...
  Route::prefix('/')->middleware('role:Owner')->group(function () {
    ...
    // Finance
    Route::get('laporan-owner','Owner\FinanceController@index')->name('finance-owner.index');
