                ...
                {{-- Menu Admin --}}
                    @if (auth::user()->auth == "Admin")
                        ...
                        <li class="nav-item {{ (request()->is('data-harga')) ? 'active' : '' }}">
                          <a href="{{url('data-harga')}}"><i class="feather icon-tag"></i><span class="menu-item" data-i18n="List">Harga Laundry</span></a>
                        </li>
                        ...
                        <li class="nav-item {{ request()->is('keuangan') ? 'active' : '' }}">
                          <a href="{{ url('keuangan') }}"><i class="feather icon-credit-card"></i><span class="menu-title" data-i18n="list">Data Keuangan</span></a>
                        </li>
                    ...
                    @elseif(auth::user()->auth == "Karyawan")
                      ...
                      <li class="nav-item {{ request()->is('laporan') ? 'active' : '' }}">
                        <a href="{{url('laporan')}}"><i class="feather icon-file-text"></i><span class="menu-title" data-i18n="Dashboard">Laporan</span></a>
                      </li>
                    ...
                    @elseif(auth::user()->auth == "Owner")
                    <li class="nav-item {{ request()->is('laporan-owner') ? 'active' : '' }}">
                        <a href="{{ url('laporan-owner') }}"><i class="feather icon-file-text"></i><span class="menu-title" data-i18n="list">Laporan</span></a>
                    </li>
